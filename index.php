...
<html lang="en-US">
	<head>
		...
		<link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#ed2e2d">
		<link rel="shortcut icon" href="/favicons/favicon.ico">
		<meta name="apple-mobile-web-app-title" content="<?php echo COMPANY_NAME; ?>">
		<meta name="application-name" content="<?php echo COMPANY_NAME; ?>">
		<meta name="msapplication-TileColor" content="#b91d47">
		<meta name="msapplication-config" content="/favicons/browserconfig.xml">
		<meta name="theme-color" content="#ed2e2d">
	</head>
